 ...
 * 
*/
export const monitorFilterType = handleAction(MONITOR_FILTER_TYPE, (state, {payload: type}) => {
 ...
 * @param string
*/
export const monitorFilterCondition = handleAction(MONITOR_FILTER_CONDITION, (state, {payload: condition}) => {
	return condition;
}, "");
 ...
 * @param boolean
*/
export const hiddenDataUrl = handleAction(HIDDEN_DATA_URL, (state, {payload: isHide}) => {
	return !!isHide;;
}, false);
