	...
	render() {
		...
		result = (
			<div className='conInfo' style={comStyle} ref='dargWrap'>
				...
				<span className='closeBtn' onClick={this._handleClose}>
					<em></em>
				</span>
				<nav className='contTab'>
					<span className={cx({ active: currentTab == 0 })} data-id='0' onClick={this._changeTab}>
						头部
					</span>
					<span className={cx({ active: currentTab == 1 })} data-id='1' onClick={this._changeTab}>
						响应数据
					</span>
				</nav>
